...
const EditTodoModal = ({ setEditModal, id }) => {
  const { data } = useGetSingleTodoQuery(id, {
    refetchOnMountOrArgChange: true,
  });
  const [updateTodo, { isSuccess, isError, error, isLoading }] =
    useUpdateTodoMutation();
  ...
  // handle edit todo function
  const handleEditTodo = (e) => {
    e.preventDefault();
    updateTodo({ id, data: { text, desc, date } });
  };
  return (
    <>
        ...
        <div className="relative sm:w-10/12 md:w-9/12 xl:w-6/12  my-6 mx-auto max-w-3xl">
          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div className="w-4/5 m-auto">
              <form className="mt-8 space-y-6" onSubmit={handleEditTodo}>
